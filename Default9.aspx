    ...
    <table class="style1" 
        ...
        <tr>
            ...
            <asp:Image ID="Image1" runat="server" Height="200" 
                    ImageUrl="~/images/D.No.N1407-A_zoom.jpg" Width="200" />
             <br />
        <b>Product id:-</b>NS001
             <br />
        <b>Product name:-</b>Rings Necklace set
        <br />
        <b>Price:-</b>1499/-
            ...
            <td style="border: thin solid #FF9900; font-family: 'Lucida Calligraphy'; font-size: large; color: #FF9900;">
                <asp:Image ID="Image2" runat="server" Height="199px" 
                    ImageUrl="~/images/li_76044yKU_indiebazaar_jewellerysets_LuxorNecklaceMangalsutraAndAnkletsCombo1739_LuxorCollections_zoom.jpg" 
                    Width="187px" />
                    <br />
        <b>Product id:-</b>NS002
             <br />
        <b>Product name:-</b>White stones necklace set
        <br />
        <b>Price:-</b>1799/-
