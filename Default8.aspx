...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Label ID="Label1" runat="server" Font-Names="Lucida Calligraphy" 
        ...
        style="top: 141px; left: 847px; position: absolute; height: 31px; width: 100px" 
        Text="Earings"></asp:Label>
        <br />
        <br />
        <br />
     <br />
    ...
    <table class="style1" 
        ...
        <tr>
            ...
            <asp:Image ID="Image1" runat="server" Height="200" ImageUrl="~/images/download.jpg" Width="200" />
             <br />
        <b>Product id:-</b>ER001
             <br />
        <b>Product name:-</b>Stones studded earings
        <br />
        <b>Price:-</b>599/-
            ...
            <td style="border: thin solid #FF9900; font-family: 'Lucida Calligraphy'; font-size: large; color: #FF9900;">
                <asp:Image ID="Image2" runat="server" Height="200" 
                    ImageUrl="~/images/Beautiful-Earings-2012-Collection-for-Eid-7.jpg" 
                    Width="200" />
                    <br />
        <b>Product id:-</b>ER002
             <br />
        <b>Product name:-</b>Silver round earings
        <br />
        <b>Price:-</b>799/-
